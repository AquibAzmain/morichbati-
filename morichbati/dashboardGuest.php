...
if (isset($_POST["GuestSubmit"])) {
    ...
    $sql = "UPDATE `applicant` SET `Guest Number`='" . $guestNo . "' where `ID` = '" . $id . "'";
    $result = $mysqli->query($sql);
    header("Refresh:0");
}
		...
		<div class="container">
			...
			<div class="col-sm-10">
				<div class="text-center">
					<?php if ($guestNo != NULL){?>
						<h4>Your chosen guest number:  </h4><h2 style = "color: #f44b42; "> <?php echo "$guestNo"; ?> </h2><br/>
					<?php }?>	
				</div>

				<p style="color: white; text-align: center">Choose Guest Number</p>
				<form name="form" action="" method="post">
					<div class="row">
						<div class="large-12 columns">


							<select name="guestNo" id="venue" style="width: 100%;">
								...
								name="GuestSubmit" class="btn btn-primary btn-block"
