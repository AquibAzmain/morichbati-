			...
			<div class="wrapper">
				...
				<nav id="sidebar">
					...
					<ul class="list-unstyled components">
						<li class="active"><a href="bookOnlinePlatinum.php">Platinum</a></li>
						<li><a href="bookOnlineDiamond.php">Diamond</a></li>
						<li><a href="bookOnlineGold.php">Gold</a></li>
								...
								<form name="form" action="costEstimation.php" method="post">
									<div class="row">
										<div class="large-12 columns">
                                            ...
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Shopping Guide" checked="checked">Wedding Shopping Guide</label>
                                            </div>
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Jeweller Recommendations" checked="checked">Jeweller Recommendations</label>
                                            </div>
                                            <div class="checkbox">
                                            ...
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Wedding Entertainment" checked="checked">Wedding Entertainment</label>
                                            </div>
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Wedding Music" checked="checked">Wedding Music</label>
                                            </div>
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Wedding Dessert Decoration" checked="checked">Wedding Dessert Decoration</label>
                                            </div>
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Palki & Horse Decoration" checked="checked">Palki and horse decoration for bride and groom</label>
                                            </div>
                                            <div class="checkbox">
