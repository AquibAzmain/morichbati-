					...
					<div>
						<div class="large-12 columns blackblur fontcolor"
							style="padding-top: 10px;padding-left:300px">
								...
								<p style="color: black; text-align: center">Add Photographer Details</p>
								<form name="form" id="myform" action="addPhotographer.php" method="post" enctype="multipart/form-data">
									<div class="row">
