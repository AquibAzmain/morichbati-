			...
			<div class="wrapper">
				...
				<nav id="sidebar">
					...
					<ul class="list-unstyled components">
						<li><a href="adminDashboard.php">Admin Dashboard</a></li><br/>
						...
						<li><a href="adminAddJeweller.php">Add Jeweller</a></li>
					<br />
					...
					<div>
						<div class="large-12 columns blackblur fontcolor"
							style="padding-top: 10px;padding-left:300px">
								...
								<p style="color: black; text-align: center">Add Theme Details</p>
								<form name="form" id="myform" action="addTheme.php" method="post" enctype="multipart/form-data">
									<div class="row">
										<div class="large-12 columns">
											...
											<textarea rows="4" cols="50" name="desc" form="myform"></textarea>
											<br><br>
											Theme Price:<br>
									...
									<div class="row">
										<div class="large-12 columns">
											<input type="submit" value="Add Theme" name="serviceSubmit" class="btn btn-primary btn-block"
