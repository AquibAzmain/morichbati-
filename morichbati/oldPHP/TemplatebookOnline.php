								...
								<form name="form" action="costEstimation.php" method="post">
									<div class="row">
										<div class="large-12 columns">
                                            ...
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Theme">Wedding Themes</label>
                                            </div>
                                            ...
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Invitation Card Recommendations">Invitation Card Recommendations</label>
                                            </div>
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Wedding Entertainment">Wedding Entertainment</label>
                                            </div>
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Wedding Music">Wedding Music</label>
                                            </div>
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Wedding Dessert Decoration">Wedding Dessert Decoration</label>
                                            </div>
                                            <div class="checkbox">
                                              <label><input type="checkbox" name="services[]" value="Flower Decoration">Flower Decoration</label>
                                            </div>
                                            <div class="checkbox">
