					...
					<div>
						<div class="large-12 columns blackblur fontcolor"
							style="padding-top: 10px;padding-left:300px">
								...
								<p style="color: black; text-align: center">Add Caterer Details</p>
								<form name="form" id="myform" action="addCaterer.php" method="post">
									<div class="row">
										<div class="large-12 columns">
											...
											<br><br>
											Caterer Minimum Price:<br>
											<input type="text" name="min">
											<br><br>
											Caterer Maximum Price:<br>
