...
$sql = "SELECT * from jeweller";
$result = $mysqli->query($sql);
while ($row = $result->fetch_assoc()) {
    $jName[] = $row["Name"];
    $jDiscount[] = $row["Discount"];
	...
	<div class="main-textgrids">
		<div class="container">
			...
			<div class="col-sm-10">
				...
				<div class="columns blackblur fontcolor"
					style="padding-top: 10px; padding-left: 20px">

					<p style="color: black; text-align: center">Jewelers</p>
					<table class="table">
						<thead>
							<tr>
								<th>Jeweler Name</th>
						...
						<tbody>
							 <?php for($x = 0; $x < $arrlength; $x++) {?>  
								...
								<td><?php  echo $jDiscount[$x];?></td>
								<td><?php  echo $jAddress[$x];?></td>
							</tr>
