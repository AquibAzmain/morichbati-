...
while ($row = $result->fetch_assoc()) {
    $jName[] = $row["Name"];
    $jPhone[] = $row["Phone Number"];
    $jEmail[] = $row["Email"];
}
$arrlength = count($jName);
				...
				<div>
					...
					<div>
						<div class="large-12 columns blackblur fontcolor"
							...
							<p style="color: black; text-align: center">Applicants</p>
							<table class="table">
								<thead>
									<tr>
							 ...
							 <?php for($x = 0; $x < $arrlength; $x++) {?>  
                                ...
                                <tr>
										<td><?php  echo $jName[$x];?></td>
										<td><?php  echo $jPhone[$x];?></td>
										<td><?php  echo $jEmail[$x];?></td>
									</tr>
